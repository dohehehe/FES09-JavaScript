...
const double = 'hello'; // string literal 방식 /결국 객체에 의해 만들어진다
const single = 'hello';
const backtick = `hello`;

const str = new String('h1'); // string constructor(생성자) function
...
const bingNumber = 123n;
console.log(typeof bingNumber);

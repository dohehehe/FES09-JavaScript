...
/* 배열 요소 변경 -------------------------------- */
friends[7] = '효재'
console.log(friends[7]); // 효재
console.log(friends); 
    // ['경민', '보미', '가희', '재훈', '도희', '남동', '원명', '효재', '진욱']
...
console.log(friends); 
    // ['태희', '경민', '보미', '가희', '재훈', '도희', '남동', '원명', '효재', '진욱']
    

let push = friends.push('태희');
console.log(push); // 11
console.log(friends); 
   // ['태희', '경민', '보미', '가희', '재훈', '도희', '남동', '원명', '효재', '진욱', '태희']
...
let copiedArray2 = [...friends];    // 얕은 복사 spread syntax (전개 구문)
let copiedArray3 = friends.slice(); // 얕은 복사 
